...
class WeatherCrawler:
    ...
    __weather_info = {
        ...
        '浮尘': {'晴雨度': 0, '晴朗度': 0, '雾度': 0, '霾度': 4, '降雨量': 0, '降雪量': 0},
        '扬沙': {'晴雨度': 0, '晴朗度': 0, '雾度': 0, '霾度': 5, '降雨量': 0, '降雪量': 0},
        '阵雨': {'晴雨度': -1, '晴朗度': 0, '雾度': 0, '霾度': 0, '降雨量': 1, '降雪量': 0},
        '小雨': {'晴雨度': -2, '晴朗度': 0, '雾度': 0, '霾度': 0, '降雨量': 2, '降雪量': 0},
        '雷阵雨': {'晴雨度': -2, '晴朗度': 0, '雾度': 0, '霾度': 0, '降雨量': 3, '降雪量': 0},
        ...
        '大到暴雨': {'晴雨度': -7, '晴朗度': 0, '雾度': 0, '霾度': 0, '降雨量': 7, '降雪量': 0},
        ...
        '暴雨': {'晴雨度': 0, '晴朗度': 0, '雾度': 0, '霾度': 0, '降雨量': 0, '降雪量': 7}
    }
    # 合法的风向
